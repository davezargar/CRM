...
30	test create	pending	9	2025-03-12 11:04:55.39386	\N	10	1	f	5
...
SELECT pg_catalog.setval('public.ticket_access_links_id_seq', 455360, true);
...
SELECT pg_catalog.setval('public.tickets_id_seq', 38, true);
