...
ALTER TABLE IF EXISTS ONLY public.tickets DROP CONSTRAINT IF EXISTS tickets_users_user_id_fk;
...
COPY public.users (user_id, email, company_fk, verified) FROM stdin;
\.
...
--
-- Name: tickets tickets_users_user_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tickets
    ADD CONSTRAINT tickets_users_user_id_fk FOREIGN KEY (user_fk) REFERENCES public.users(user_id);
